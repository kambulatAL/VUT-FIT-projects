...
GRANT ALL ON XALAKA00.DEPARTMENTS TO XSHEVC01 WITH GRANT OPTION; --дать права с правом давать права
REVOKE ALL ON XALAKA00.DIAGNOSTIC TO XSHEVC01; --забрать данные права
GRANT ALL ON XALAKA00.DOCTORSNURSES TO XSHEVC01;
GRANT SELECT ON XALAKA00.DOSEOFMEDICINES TO XSHEVC01;
