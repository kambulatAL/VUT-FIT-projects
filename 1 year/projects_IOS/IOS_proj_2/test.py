...
test("Stress test 4 (100, 101, 50, 50)")
processSucess(100, 101, 50, 50)

test("Stress test 5 (1000, 1001, 20, 20)")
processSucess(100, 101, 20, 20)

test("Stress test 6 (30, 30, 30, 30)")
processSucess(30, 30, 30, 30)

test("Stress test 7 (45, 51, 100, 100)")
processSucess(45, 51, 100, 100)

test("Stress test 7 (65, 50, 3, 3)")
processSucess(65, 50, 3, 3)

test("Stress test 8 (12, 10, 30, 30)")
processSucess(12, 10, 30, 30)
test("Stress test 9 (15, 15, 40, 40)")
processSucess(15, 15, 40, 40)
testEnd()
